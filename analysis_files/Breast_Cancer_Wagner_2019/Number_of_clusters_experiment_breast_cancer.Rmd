...
sce_subdir <- file.path(external_data_root, "sce_objects", "Breast_Cancer_Wagner_2019")
```
...
metadata <- read.csv(file.path(sce_subdir, 'breast_cancer_metadata.csv'))
...
```{r}
load(file.path(sce_subdir, 'breast_cancer_train_MMD_VAE_sce.RData'))
load(file.path(sce_subdir, 'breast_cancer_test_MMD_VAE_sce.RData'))
```
