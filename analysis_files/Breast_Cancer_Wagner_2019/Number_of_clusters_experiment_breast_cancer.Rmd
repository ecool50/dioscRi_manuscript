...
metadata <- read.csv(file.path(external_data_root, 'Breast_Cancer_Wagner_2019/data/breast_cancer_metadata.csv'))
...
```{r}
load(file.path(external_data_root, 'Breast_Cancer_Wagner_2019/data/breast_cancer_train_MMD_VAE_sce.RData'))
load(file.path(external_data_root, 'Breast_Cancer_Wagner_2019/data/breast_cancer_test_MMD_VAE_sce.RData'))
```
