...
```{r}
metaData <- read.csv(file.path(external_data_root, 'DeepLearningCyTOF/cmv_metadata.csv'))
metaData <- metaData[, -1]
...
```{r}
load(file.path(external_data_root, "DeepLearningCyTOF/Data/cmv_train_MMD_VAE_sce.RData"))
load(file.path(external_data_root, "DeepLearningCyTOF/Data/cmv_test_MMD_VAE_sce.RData"))
```
