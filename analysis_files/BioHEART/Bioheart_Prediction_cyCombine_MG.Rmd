...
markerMeanCellType_val <- computeFeatures(sce = sce_cycombine_val, featureType = 'mean', 
                              cellTypeCol = 'mg_clusters', sampleCol = 'sample_id', 
                              logit = T, useMarkers = useMarkers, assay = "corrected")
# colnames(markerMeanCellType_val) <- as.factor(colnames(markerMeanCellType))
```
...
write.csv(test_auc$preds,
          '../dioscRi_manuscript/auc_data/mg_cyCombine_auc_all_study_3.csv')
...
write.csv(test_auc$preds,
          '../dioscRi_manuscript/auc_data/mg_cyCombine_auc_prop_study_3.csv')
...
write.csv(test_auc$preds,
          '../dioscRi_manuscript/auc_data/mg_cyCombine_auc_means_study_3.csv')
...
pdf(file = "../dioscRi_manuscript/Plots/feature_trees_mg_cyCombine.pdf",   # The directory you want to save the file in
