...
write.csv(test_auc$preds,
          '../dioscRi_manuscript/auc_data/fs_cyCombine_auc_all_study_3.csv')
...
write.csv(test_auc$preds,
          '../dioscRi_manuscript/auc_data/fs_cyCombine_auc_prop_study_3.csv')
...
write.csv(test_auc$preds,
          '../dioscRi_manuscript/auc_data/fs_cyCombine_auc_means_study_3.csv')
...
pdf(file = "../dioscRi_manuscript/Plots//feature_trees_fs_cyCombine.pdf",   # The directory you want to save the file in
