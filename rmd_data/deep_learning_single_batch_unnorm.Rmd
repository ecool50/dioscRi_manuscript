---
title: "Deep Learning singe batch unormalised"
...
for(batch in batches){
  ...
  train_batch$clusters_mg <- factor(train_batch$mg_cell_type_distinct)
  train_batch$batch <- train_batch$CyTOF.Batch
  ...
  # training MG model
  nnet_model_mg <- fitCelltypeModel(train_x = train_batch_sub[, useMarkers],
                                  train_y = train_batch_sub$clusters_mg)
...
write.csv(dat_final_mg, '../concordance_data/deep_learning_single_batches_unnorm.csv', row.names = F)
```
